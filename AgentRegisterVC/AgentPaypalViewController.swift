//
//  AgentPaypalViewController.swift
//  Hoodable
//
...
class AgentPaypalViewController: UIViewController {
    ...
    @IBAction func registerAction (_ sender : Any)
    {
        ...
        if message != "" {
            ...
            let  registerPasswordViewController = storyboard.instantiateViewController(withIdentifier: "AgentAddressViewController") as! AgentAddressViewController
