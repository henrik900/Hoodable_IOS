//
//  AgentNameViewController.swift
//  Hoodable
//
//  Created by Rustam Atabaev on 10/02/20.
//  Copyright © 2020 Rustam Atabaev. All rights reserved.
//

import UIKit

class AgentNameViewController: UIViewController {
    ...
    @IBAction func registerAction (_ sender : Any)
    {
        ...
        if message != "" {
            ...
            let  registerMobileViewController = storyboard.instantiateViewController(withIdentifier: "AgentEmailViewController") as! AgentEmailViewController
