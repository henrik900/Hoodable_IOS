...
class RegisterMobileViewController: UIViewController {
...
var userTypeString = String()
    ...
    @IBAction func registerAction (_ sender : Any)
    {
        ...
        if message != "" {
            ...
            let  registerDOBViewController = storyboard.instantiateViewController(withIdentifier: "RegisterEmailViewController") as! RegisterEmailViewController
            
            registerDOBViewController.givenNameString = givenNameString
            registerDOBViewController.familyNameString = familyNameString
            registerDOBViewController.mobNoString = mobTF.text!
            registerDOBViewController.userTypeString  =  userTypeString
