...
//  Hoodable
//
//  Created by Rustam Atabaev on 19/12/19.
...
var userTypeString = String()
    ...
    @IBAction func registerAction (_ sender : Any)
    {
        ...
        if message != "" {
            ...
            let  registerDOBViewController = storyboard.instantiateViewController(withIdentifier: "RegisterDOBViewController") as! RegisterDOBViewController
            
            registerDOBViewController.givenNameString = givenNameString
            registerDOBViewController.familyNameString = familyNameString
            registerDOBViewController.mobNoString = mobNoString
